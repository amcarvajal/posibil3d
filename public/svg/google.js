import styles from "../../components/nav/nav.module.css";
 ...
 const googleicon = () => {
    return (
        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" className={styles.googleicon} role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
